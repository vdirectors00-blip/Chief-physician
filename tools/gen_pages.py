...
},
{
 ...
 'do':[('보유 자원 확인','연구 인력, 연구 공간, 매출과 업력, 기술 자료를 먼저 확인합니다. 지금 되는 인증과 준비가 더 필요한 인증을 나눕니다.'),
       ...
       ('성장 전략과 연결','인증 자체가 목적이 아닙니다. 정책자금 가점, 지원사업 자격, 연구개발 세액공제처럼 인증이 실제로 쓰이는 자리에 붙입니다. 연구소 부동산에 붙는 지방세 감면은 2026년부터 비수도권 중심으로 다시 짜였습니다. 사업장이 어디인지에 따라 달라지므로 지역 기준부터 확인합니다.')],
 'check':[('이노비즈','기술혁신형입니다. 연구개발 역량과 기술 경쟁력, 사업화 가능성을 봅니다. 기술 증빙 정리가 관건입니다.'),
          ...
          ('벤처기업','벤처투자, 연구개발, 혁신성장 세 유형 중 하나로 확인받습니다. 연구개발유형은 연구소나 전담부서와 연구개발비 요건이 함께 걸리고, 혁신성장유형은 기술의 혁신성과 사업의 성장성을 평가받습니다. 어느 유형으로 갈지부터 정합니다.')],
 'faq':[('연구소와 전담부서 중 무엇이 낫나요?','부동산에 붙는 지방세 감면은 기업부설연구소 쪽에서 봅니다. 다만 2026년부터 지역에 따라 감면 폭이 달라졌고 전담부서보다 인원 요건도 높습니다. 지금 인력으로 가능한 쪽부터 밟아 올라가는 편이 낫습니다.'),
...
},
{
 ...
 'check':[('입주 자격','지식산업센터는 제조업과 지식산업, 정보통신산업 등 입주 가능 업종이 정해져 있습니다.'),
          ...
          ('취득 이후','취득세와 재산세, 유지비까지 넣고 임대료와 비교해야 실제 이득이 보입니다. 지식산업센터에 붙던 지방세 감면은 2026년부터 지역별로 다시 짜여서 물건 위치에 따라 계산이 달라집니다.')],
...
<div class="float" id="float">
  <!-- TODO:KAKAO -->
  <a class="float__btn float__btn--kakao" href="#" data-pending="카카오톡 채널 준비중" data-tip="" aria-label="카카오톡 상담">
  ...
  <!-- TODO:INSTA -->
  <a class="float__btn float__btn--insta" href="#" data-pending="인스타그램 준비중" data-tip="" aria-label="인스타그램">
